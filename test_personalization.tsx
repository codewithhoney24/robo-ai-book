...
import { PersonalizationProvider } from './website/src/contexts/PersonalizationContext';
import PersonalizedDocsList from './website/src/components/PersonalizedDocsList';
import PersonalizeButton from './website/src/components/PersonalizeButton';

// Test component to validate personalization functionality
const TestPersonalization = () => {
  return (
    <PersonalizationProvider>
      <div>
        <h1>Personalization Test</h1>
        <PersonalizeButton />
        <PersonalizedDocsList />
      </div>
    </PersonalizationProvider>
  );
};

// Test to validate the filtering logic
...
export default TestPersonalization;