...
# Set the DATABASE_URL to use local PostgreSQL for this operation
os.environ["DATABASE_URL"] = "postgresql://localhost:5432/auth_service_db?sslmode=prefer"

# Now import and run the database creation script logic
import psycopg2
from urllib.parse import urlparse

# Get the database URL from the environment (now set to local)
